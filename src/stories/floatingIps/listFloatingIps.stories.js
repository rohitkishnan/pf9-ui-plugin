...
import FloatingIpsList from 'openstack/components/floatingips/FloatingIpsList'
...
addStories('Floating IP Management/Listing floating IPs', {
  'With no floatingIps': () => (
    <FloatingIpsList floatingIps={[]} onAdd={addAction} onDelete={deleteAction} />
  ),

  'With some floatingIps': () => (
    <FloatingIpsList floatingIps={someFloatingIps} onAdd={addAction} onDelete={deleteAction} />
  ),
  ...
  'With pagination': () => {
    ...
    return (
      <FloatingIpsList floatingIps={floatingIps} onAdd={addAction} onDelete={deleteAction} />
    )
  },
})
